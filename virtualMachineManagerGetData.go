...
func (vmm *AwsVirtualMachineManager) GetData(ctx context.Context) (map[string]models.VirtualMachineSize, error) {
...
func (vmm *AwsVirtualMachineManager) GetUsage(ctx context.Context) (map[string]models.VirtualMachineFamily, error) {
...
func (vmm *AwsVirtualMachineManager) GetDataWithUsage(ctx context.Context) (map[string]models.VirtualMachineSize, error) {
...
// func (vmm *AwsVirtualMachineManager) GetLatestImageVersion(ctx context.Context, imageName string) (string, error) {

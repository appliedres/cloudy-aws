...
func (vmm *AwsVirtualMachineManager) GetAllDisks(ctx context.Context) ([]*models.VirtualMachineDisk, error) {
	...
	// func (vmm *AwsVirtualMachineManager) DeleteDisk(ctx context.Context, diskName string) error {
	...
	// func (vmm *AwsVirtualMachineManager) GetOsDisk(ctx context.Context, vmId string) (*models.VirtualMachineDisk, error) {
	...
	// func (vmm *AwsVirtualMachineManager) GetAllVmDisks(ctx context.Context, vmId string) ([]*models.VirtualMachineDisk, error) {
	// 	disks := []*models.VirtualMachineDisk{}
